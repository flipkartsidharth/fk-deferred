...
/*global exports: true, require: true, console: true, setTimeout: true */
...
var defaultMonitor = {
    unhandledException: function(ex) {
        console.log('Deferred callback raised an exception: ', ex.message);
        console.log(ex.stack);

    },
    expectationFailed: function(msg) {
        console.log('Expectation failed: ', msg.message);
    }
};
